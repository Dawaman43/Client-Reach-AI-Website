    ...
    <section className="py-24 bg-white dark:bg-dark-bg">
        <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-10 max-w-3xl mx-auto">
                Client Reach AI builds smart digital teams for businesses — including AI receptionists, follow-up
                agents, customer support assistants, and marketing automation systems. These AI agents work
                together as one digital workforce to help you capture more leads, recover lost revenue, and keep
