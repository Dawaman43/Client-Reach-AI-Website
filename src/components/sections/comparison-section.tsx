                ...
                <div className="lg:col-span-2">
                    <FadeIn direction="left">
                        ...
                        <div className="space-y-4 text-gray-600 dark:text-gray-300 text-lg leading-relaxed">
                            <p>
                                Most AI tools and chatbots can only handle one small task. But in any business, missing a call, a
                                message, or a follow-up can mean losing revenue to a competitor.
                            </p>
                            <p>
                            ...
                            <p>
                                This isn’t basic automation. It’s intelligent AI that learns how your business operates, works
                                across your entire operation, and helps you grow, close more deals, and keep everything running
                                smoothly.
                            </p>
                        </div>
                    </FadeIn>
