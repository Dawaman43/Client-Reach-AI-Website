                ...
                <FadeIn>
                    <div className="relative max-w-7xl mx-auto px-4 text-center">
                        ...
                        <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-10 leading-relaxed">
                            Booking a consultation with Client Reach AI helps you clearly see where your business is losing
                            time, money, and potential customers — and how AI can fix it fast.            </p>
                        <button
                        ...
                        {[
                            {
                                step: "01",
                                title: "Consultation",
                                desc: "Book a 1-on-1 consultation to pinpoint exactly where AI can create the biggest impact in your clinic — from capturing more bookings to streamlining patient communication and reducing admin workload.",
                            },
                            {
                                step: "02",
                                title: "Integration",
                ...
                <FadeIn>
                    ...
                    <div className="bg-white dark:bg-dark-card rounded-2xl p-6 border border-gray-100 dark:border-dark-border">
                        <AccordionItem
                            ...
                            answer="Client Reach AI’s AI Call Analysis and Follow-Up Agents capture and respond to every missed or
mishandled call or enquiry. By automatically following up and improving response times, lost
opportunities are converted into booked calls, meetings, or sales — helping businesses recover lost
revenue and increase conversion rates by up to 40%."
                        />
                        <AccordionItem
                            question="Can AI replace a receptionist or admin role in a business?"
                            answer="Our AI Receptionist is designed to support — not replace — your team. It handles call over ow,
after-hours enquiries, and automated follow-ups, allowing your staff to focus on high-value work
and customer interactions."
                        />
                        <AccordionItem
                            question="Is this solution suitable for multi-location businesses?"

                            answer={`Yes. Our AI systems are built to scale across multiple locations and teams.
Businesses can expect increased operational efficiency, lower costs, and improved customer experience — all managed from a centralised system.

We focus on delivering measurable results that align with your business goals, including higher conversion rates, better response times, and improved productivity across the entire operation.`}
                        />
                        <AccordionItem
                            question="How quickly can a business see results?"
                            answer="Most businesses begin seeing ROI within 30 days by recovering missed revenue from unconverted
calls, enquiries, and follow-ups that were previously slipping through the cracks."
                        />
                    </div>
                </FadeIn>
            </section>
