    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(
                "https://clientreachai.app.n8n.cloud/webhook/581da088-fd0d-4262-b540-2f1a9c08920c", // process.env.NEXT_PUBLIC_N8N_WEBHOOK_URL || "",
                {
                    method: "POST",
                    headers: {
                    ...
                    <div className="w-full md:max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                        <div className="text-left order-2 md:order-1">
                            ...
                            <p className="text-base md:text-lg text-gray-600 dark:text-gray-300 mb-6 md:mb-8 leading-relaxed">
                                Every missed call or enquiry is a missed opportunity. Client Reach AI’s AI Receptionist and Call
                                Analysis Agents help businesses capture missed leads, recover lost revenue, and improve
                                conversion rates.                            </p>
                        </div>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-5">
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                disabled={isSubmitting || isRateLimited}
                                                rows={4}
                                                className={`w-full px-4 py-3 rounded-lg bg-gray-50 dark:bg-gray-800 border outline-none transition-all ${fieldErrors.inquiry
                                                    ? "border-red-300 dark:border-red-700 focus:ring-2 focus:ring-red-500"
                                                    : "border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-brand-500"
                                                    } ${isSubmitting || isRateLimited
                                                        ? "opacity-60 cursor-not-allowed"
